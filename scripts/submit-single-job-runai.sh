...
# Submits ONE Run:ai training job that runs all 480 simulations sequentially
# using scripts/run-all-sims.sh inside the container.
# ---------------------------------------------------------------------------
...
JOB_NAME="${JOB_NAME:-osr-all-sims}"
...
echo "============================================"
echo "OpenSimRoot — Submit Single Job (All Sims)"
